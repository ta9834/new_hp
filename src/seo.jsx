...
const PAGE_META = {
  top: {
    ...
    description: "株式会社PAS企画は茨城県つくば市を拠点とする独立系コングロマリット型アドバイザリー。資産形成・税務対策・不動産活用・経営サポート・AI導入支援の5領域を一つの窓口で横断的に支援します。初回相談無料。",
  },
  about: {
  ...
  services: {
    title: "事業内容 | 資産形成・税務・不動産・経営・AI導入支援 | 株式会社PAS企画",
    description: "資産形成・税務対策・不動産総合活用・経営サポート・AI導入支援——5つの専門領域を一つの組織で横断的に支援するコングロマリット型アドバイザリーサービス。",
  },
  consultant: {
